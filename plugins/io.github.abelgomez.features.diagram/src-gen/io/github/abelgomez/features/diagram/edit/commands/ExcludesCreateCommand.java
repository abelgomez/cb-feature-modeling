 ...
 * @generated
 */
public class ExcludesCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ExcludesCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return FeaturesBaseItemSemanticEditPolicy.getLinkConstraints().canCreateExcludes_4012(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Excludes newElement = FeaturesFactory.eINSTANCE.createExcludes();
	...
	* @generated
	*/
	protected void doConfigure(Excludes newElement, IProgressMonitor monitor, IAdaptable info)
