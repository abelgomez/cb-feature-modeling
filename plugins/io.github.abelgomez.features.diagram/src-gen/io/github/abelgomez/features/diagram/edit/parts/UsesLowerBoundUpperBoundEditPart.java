 ...
 * @generated
 */
public class UsesLowerBoundUpperBoundEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				FeaturesVisualIDRegistry.getType(
						io.github.abelgomez.features.diagram.edit.parts.UsesLowerBoundUpperBoundEditPart.VISUAL_ID),
				new Point(-10, -10));
	}
	...
	* @generated
	*/
	public UsesLowerBoundUpperBoundEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FeaturesParserProvider.getParser(FeaturesElementTypes.Uses_4013, getParserElement(),
					FeaturesVisualIDRegistry.getType(
							io.github.abelgomez.features.diagram.edit.parts.UsesLowerBoundUpperBoundEditPart.VISUAL_ID));
		}
		return parser;
