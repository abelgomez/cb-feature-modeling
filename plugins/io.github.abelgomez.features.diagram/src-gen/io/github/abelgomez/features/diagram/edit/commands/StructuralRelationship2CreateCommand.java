 ...
 * @generated
 */
public class StructuralRelationship2CreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return FeaturesBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateStructuralRelationship_4009(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_StructuralRelationship_4009(newElement);
