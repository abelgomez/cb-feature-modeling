...
public class FeatureNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FeaturesParserProvider.getParser(FeaturesElementTypes.Feature_2003, getParserElement(),
					FeaturesVisualIDRegistry
							.getType(io.github.abelgomez.features.diagram.edit.parts.FeatureNameEditPart.VISUAL_ID));
		}
		return parser;
	}
