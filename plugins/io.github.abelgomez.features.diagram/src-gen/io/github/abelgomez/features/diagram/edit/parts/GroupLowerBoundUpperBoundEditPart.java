 ...
 * @generated
 */
public class GroupLowerBoundUpperBoundEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				FeaturesVisualIDRegistry.getType(
						io.github.abelgomez.features.diagram.edit.parts.GroupLowerBoundUpperBoundEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public GroupLowerBoundUpperBoundEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FeaturesParserProvider.getParser(FeaturesElementTypes.Group_3005, getParserElement(),
					FeaturesVisualIDRegistry.getType(
							io.github.abelgomez.features.diagram.edit.parts.GroupLowerBoundUpperBoundEditPart.VISUAL_ID));
		}
		return parser;
