 ...
 * @generated
 */
public class ImpliesReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ImpliesReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Implies) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return FeaturesBaseItemSemanticEditPolicy.getLinkConstraints().canExistImplies_4010(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected Implies getLink() {
		return (Implies) getElementToEdit();
	}
