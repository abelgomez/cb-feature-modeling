 ...
 * @generated
 */
public class GroupLowerBoundUpperBound2EditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				FeaturesVisualIDRegistry.getType(
						io.github.abelgomez.features.diagram.edit.parts.GroupLowerBoundUpperBound2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public GroupLowerBoundUpperBound2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FeaturesParserProvider.getParser(FeaturesElementTypes.Group_3006, getParserElement(),
					FeaturesVisualIDRegistry.getType(
							io.github.abelgomez.features.diagram.edit.parts.GroupLowerBoundUpperBound2EditPart.VISUAL_ID));
		}
		return parser;
