 ...
 * @generated
 */
public class StructuralRelationshipLowerBoundUpperBoundEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(FeaturesVisualIDRegistry.getType(
				io.github.abelgomez.features.diagram.edit.parts.StructuralRelationshipLowerBoundUpperBoundEditPart.VISUAL_ID),
				new Point(-10, -10));
	}
	...
	* @generated
	*/
	public StructuralRelationshipLowerBoundUpperBoundEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FeaturesParserProvider.getParser(FeaturesElementTypes.StructuralRelationship_4008,
