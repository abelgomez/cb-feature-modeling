...
import io.github.abelgomez.features.diagram.edit.policies.AttributeItemSemanticEditPolicy;
...
public class AttributeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FeaturesParserProvider.getParser(FeaturesElementTypes.Attribute_3007, getParserElement(),
					FeaturesVisualIDRegistry
							.getType(io.github.abelgomez.features.diagram.edit.parts.AttributeEditPart.VISUAL_ID));
		}
		return parser;
	}
