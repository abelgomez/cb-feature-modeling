...
public class FeatureCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return FeaturesPackage.eINSTANCE.getFeature_Group();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<FeaturesNodeDescriptor> childDescriptors = FeaturesDiagramUpdater
				.getFeature_2003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == GroupEditPart.VISUAL_ID || visualID == Group2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<FeaturesNodeDescriptor> childDescriptors = FeaturesDiagramUpdater
				.getFeature_2003SemanticChildren((View) getHost().getModel());
		...
		HashMap<FeaturesNodeDescriptor, LinkedList<View>> potentialViews = new HashMap<FeaturesNodeDescriptor, LinkedList<View>>();
		//
