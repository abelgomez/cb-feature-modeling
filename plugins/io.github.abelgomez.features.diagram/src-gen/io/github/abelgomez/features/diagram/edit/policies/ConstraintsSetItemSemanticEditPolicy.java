 ...
 * @generated
 */
public class ConstraintsSetItemSemanticEditPolicy extends FeaturesBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ConstraintsSetItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (FeaturesVisualIDRegistry
					.getVisualID(incomingLink) == ConstrainableElementConstraintsSetEditPart.VISUAL_ID) {
