...
import io.github.abelgomez.features.diagram.edit.policies.FeaturesTextSelectionEditPolicy;
 ...
 * @generated
 */
public class StructuralRelationshipLowerBoundUpperBound2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(FeaturesVisualIDRegistry.getType(
				io.github.abelgomez.features.diagram.edit.parts.StructuralRelationshipLowerBoundUpperBound2EditPart.VISUAL_ID),
				new Point(-10, -10));
	}
	...
	* @generated
	*/
	public StructuralRelationshipLowerBoundUpperBound2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new FeaturesTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FeaturesParserProvider.getParser(FeaturesElementTypes.StructuralRelationship_4009,
					getParserElement(), FeaturesVisualIDRegistry.getType(
							io.github.abelgomez.features.diagram.edit.parts.StructuralRelationshipLowerBoundUpperBound2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, FeaturesEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new MultiplicityLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MultiplicityLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MultiplicityLabelFigure() {
			this.setText("");
