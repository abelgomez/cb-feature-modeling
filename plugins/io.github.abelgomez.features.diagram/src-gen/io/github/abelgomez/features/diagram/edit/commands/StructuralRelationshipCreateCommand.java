 ...
 * @generated
 */
public class StructuralRelationshipCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	private final FeatureModel container;

	/**
	* @generated
	*/
	public StructuralRelationshipCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof RelatableElement) {
			return false;
		}
		...
		return FeaturesBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateStructuralRelationship_4008(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_StructuralRelationship_4008(newElement);
	...
	* @generated
	*/
	protected void doConfigure(StructuralRelationship newElement, IProgressMonitor monitor, IAdaptable info)
	...
	*/
	protected RelatableElement getSource() {
		return (RelatableElement) source;
	}
	...
	* @generated
	*/
	private static FeatureModel deduceContainer(EObject source, EObject target) {
		// Find container element for the new link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
		for (EObject element = source; element != null; element = element.eContainer()) {
			if (element instanceof FeatureModel) {
				return (FeatureModel) element;
			}
		}
		return null;
	}
