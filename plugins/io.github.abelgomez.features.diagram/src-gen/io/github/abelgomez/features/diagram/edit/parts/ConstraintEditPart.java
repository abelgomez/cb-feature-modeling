...
import io.github.abelgomez.features.diagram.edit.policies.ConstraintItemSemanticEditPolicy;
import io.github.abelgomez.features.diagram.edit.policies.FeaturesTextNonResizableEditPolicy;
...
public class ConstraintEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new FeaturesTextNonResizableEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return FeaturesElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FeaturesParserProvider.getParser(FeaturesElementTypes.Constraint_3008, getParserElement(),
					FeaturesVisualIDRegistry
							.getType(io.github.abelgomez.features.diagram.edit.parts.ConstraintEditPart.VISUAL_ID));
		}
		return parser;
	}
