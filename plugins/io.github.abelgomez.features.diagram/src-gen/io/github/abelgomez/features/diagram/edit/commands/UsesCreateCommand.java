 ...
 * @generated
 */
public class UsesCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public UsesCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return FeaturesBaseItemSemanticEditPolicy.getLinkConstraints().canCreateUses_4013(getContainer(), getSource(),
				getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Uses newElement = FeaturesFactory.eINSTANCE.createUses();
	...
	* @generated
	*/
	protected void doConfigure(Uses newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
