 ...
 * @generated
 */
public class BiconditionalReorientCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Biconditional) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return FeaturesBaseItemSemanticEditPolicy.getLinkConstraints().canExistBiconditional_4011(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected Biconditional getLink() {
		return (Biconditional) getElementToEdit();
	}
