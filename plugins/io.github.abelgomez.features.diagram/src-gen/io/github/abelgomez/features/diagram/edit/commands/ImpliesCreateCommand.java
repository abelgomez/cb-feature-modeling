 ...
 * @generated
 */
public class ImpliesCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ImpliesCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return FeaturesBaseItemSemanticEditPolicy.getLinkConstraints().canCreateImplies_4010(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Implies newElement = FeaturesFactory.eINSTANCE.createImplies();
	...
	* @generated
	*/
	protected void doConfigure(Implies newElement, IProgressMonitor monitor, IAdaptable info)
