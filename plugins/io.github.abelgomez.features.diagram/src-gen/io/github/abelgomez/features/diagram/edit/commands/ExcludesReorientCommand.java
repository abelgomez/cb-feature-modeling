 ...
 * @generated
 */
public class ExcludesReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ExcludesReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Excludes) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return FeaturesBaseItemSemanticEditPolicy.getLinkConstraints().canExistExcludes_4012(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected Excludes getLink() {
		return (Excludes) getElementToEdit();
	}
